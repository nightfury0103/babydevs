...
const infuraId = ""; // Replace with your Infura ID
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setState({
        errorMessage: (
          <>
            Unable to detect <strong>MetaMask</strong>. Go to the Metamask
            website. <br /> Click “Get Chrome Extension” to install Metamask.
            <br />
            Click “Add to Chrome” in the upper right.
            <br />
            Click “Add Extension” to complete the installation. ...
            <br />
            Click on the Metamask logo in the upper right hand corner of your
            Google chrome browser..
            <br />
            <br />
            But don't worry! <span className="emoji">😃</span> You can interact
            with the smart-contract through{" "}
              ...
              <>
                  ...
                  {this.isNotMainnet() ? (
                    <div className="not-mainnet">
                      ...
                      <span className="small">
                        Current network:{" "}
                        <strong>{this.state.network?.name}</strong>
                      </span>
                    </div>
                  ) : null}
                ...
                {this.state.totalSupply < this.state.maxSupply ? (
                  ...
                  <div className="collection-sold-out">
                    <h2>
                      BabyDevs are <strong>SOLD OUT</strong>!{" "}
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ? (
          <div className="no-wallet">
            ...
            <div className="use-etherscan">
              Welcome to the <strong> !!!!!</strong>
              <br />
              Please connect to your <strong>METAMASK</strong> <br />
              <br />
              <strong>No Metamask ? No probblem </strong>
              <br /> Go to the Metamask website. <br /> Click “Get Chrome
              Extension” to install Metamask.
              <br />
              Click “Add to Chrome” in the upper right.
              <br />
              Click “Add Extension” to complete the installation. ...
              ...
              Google chrome browser..
              <br />
              <br /> You can interact with the smart-contract{" "}
